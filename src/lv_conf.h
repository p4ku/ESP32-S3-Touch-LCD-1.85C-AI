...
#define LV_CONFIG
 ...
 #define LV_COLOR_16_SWAP   0 // for SPI and parallel 8


#undef LV_INDEV_DEF_GESTURE_LIMIT
#define LV_INDEV_DEF_GESTURE_LIMIT 80       // default is 50 — increase to 80 or 100
#undef LV_INDEV_DEF_GESTURE_MIN_VELOCITY
#define LV_INDEV_DEF_GESTURE_MIN_VELOCITY 50 // optional: increase to 60–70 if needed
...
#define LV_USE_FONT_SUBPX 0 // Keep disabled unless you're using subpixel rendering
